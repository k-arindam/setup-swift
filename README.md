...
<p>
  ...
  <a href="https://github.com/k-arindam/setup-swift/releases/latest">
    <img src="https://img.shields.io/github/v/release/k-arindam/setup-swift?sort=semver" alt="Latest release" />
  </a>
</p>
...
YAML interprets eg. `6.0` as a float, this action will then interpret that as `6` which will result in eg. Swift 6.6 being resolved. Quote your inputs! Thus:
